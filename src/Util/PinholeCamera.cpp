...
/**
 * Will calculate distance to goal and angle offset, need to call update every time new target information is acquired to return proper Yaw/Distance
 *
 */
PinholeCamera::PinholeCamera(int pixel_width, int pixel_height, float FOV_width, float FOV_height, int angle_offset, float target_height) {
